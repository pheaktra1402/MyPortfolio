      ...
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <h2 className="hero-subtitle">
            Third-Year Computer Science Student at National Polytechnic
            Institute of Cambodia
          </h2>

          <p className="hero-description">
            Specializing in web development. A fast learner and responsible
            developer ready for new challenges.
          </p>
